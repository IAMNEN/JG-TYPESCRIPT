...
var Student = /** @class */ (function (_super) {
    ...
    function Student(name, age, course) {
        var _this = _super.call(this, name, age) || this; // call parent constructor
        _this.course = course;
        return _this;
    }
    Student.prototype.displayDetails = function () {
        _super.prototype.displayDetails.call(this); // show name and age
        console.log("Course: ".concat(this.course));
    };
    return Student;
}(Person));
var student1 = new Student("John", 20, "BCA");
